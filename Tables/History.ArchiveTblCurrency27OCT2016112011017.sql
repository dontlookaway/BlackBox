CREATE TABLE [History].[ArchiveTblCurrency27OCT2016112011017]
(
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Logs from TblCurrency change logs', 'SCHEMA', N'History', 'TABLE', N'ArchiveTblCurrency27OCT2016112011017', NULL, NULL
GO
