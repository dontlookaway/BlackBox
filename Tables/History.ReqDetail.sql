...
GO
ALTER TABLE [History].[ReqDetail] ADD CONSTRAINT [ReqDetail_ID] PRIMARY KEY CLUSTERED  ([SignatureDatetime], [Operator], [ProgramName], [ItemKey], [DatabaseName]) WITH (IGNORE_DUP_KEY=ON) ON [PRIMARY]
GO
