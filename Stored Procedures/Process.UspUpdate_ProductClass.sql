...
Insert Lookups.ProductClass
        ( Company, ProductClass, ProductClassDescription , LastUpdated )
SELECT Company
     , ProductClass
...
If @PrevCheck=1
	Begin
		...
		Select @CurrentCount=COUNT(*) From Lookups.ProductClass
		Where LastUpdated=@LastUpdated

		Select @PreviousCount=COUNT(*) From Lookups.ProductClass
		Where LastUpdated<>@LastUpdated
...
Begin
	Print 'UspUpdate_ProductClass - Table was last updated at '+CAST(@LastDate As VARCHAR(255))+' no update applied'
End
