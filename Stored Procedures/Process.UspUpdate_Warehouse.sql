...
/*
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///			Stored procedure created by Chris Johnson, Prometic Group September 2015 to populate table with warehouse details		///
...
Insert Lookups.Warehouse
        ( Company, Warehouse, LastUpdated, WarehouseDescription)
SELECT Company
     , Warehouse
	 , @LastUpdated
	 , Case When Warehouse='CE' Then 'Certified Environment'
			When Warehouse='RL' Then 'Red Label'
			When Warehouse='ZV' Then 'Zero Value'
			When Warehouse='RM' Then 'Raw Materials'
			When Warehouse='QU' Then 'Quarantine'
			When Warehouse='CB' Then 'Cambridge'
			When Warehouse='FG' Then 'Finished Goods'
		End
	  FROM #Table1Wh
...
If @PrevCheck=1
	Begin
		...
		Select @CurrentCount=COUNT(*) From Lookups.Warehouse
		Where LastUpdated=@LastUpdated

		Select @PreviousCount=COUNT(*) From Lookups.Warehouse
		Where LastUpdated<>@LastUpdated
...
Begin
	Print 'UspUpdate_Warehouse - Table was last updated at '+CAST(@LastDate As VARCHAR(255))+' no update applied'
End
